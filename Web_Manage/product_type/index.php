...
$col[] = array('column' => $colname['ispublic'], 'name' => coderLang::t("public", 1), 'order' => true, 'width' => '60');
$col[] = array('column' => 'num', 'name' => coderLang::t("quantityOfSubtype", 1), 'order' => false, 'width' => '60');
$col[] = array('column' => 'productNum', 'name' => coderLang::t("quantityOfProduct", 1), 'order' => false, 'width' => '60');
      ...
      $('#table1').coderlisthelp({
        ...
        callback: function(obj, rows) {
          ...
          for (var i = 0; i < count; i++) {
            ...
            $tr.append('<td>' + row["productNum"] + '</td>');
