...
$.fn.coderlisthelp = function(settings) {
	...
	return this.each(function() {
		...
		function linkInit(){
			...
			parent.find('#addBtn').colorbox({iframe:true,innerWidth: '95%',innerHeight: '95%',scrolling: !isnicescroll,transition:'none',initialWidth:'95%',initialHeight:'95%',speed:200,fixed:true,onClosed:function(){parent.find('#refreshBtn').click()}});
			
			parent.find('#addexcelBtn').colorbox({iframe:true,innerWidth: '95%',innerHeight: '95%',scrolling: !isnicescroll,transition:'none',initialWidth:'95%',initialHeight:'95%',speed:200,fixed:true,onClosed:function(){parent.find('#refreshBtn').click()}});
		}
			...
			if(manage){
				...
				parent.find('tbody tr').each(function(){
					...
					if(_settings.editlink!=""){
						...
						edit.click(function(){
							$.colorbox({href:_settings.editlink+'?'+tr.attr('editlink'),iframe:true, innerWidth: '95%', innerHeight: '95%', scrolling: !isnicescroll,transition:'none',initialWidth:'95%',initialHeight:'95%',speed:200,fixed:true,onClosed:function(){parent.find('#refreshBtn').click()}});
						});
						td.append(edit);
					}
					if(_settings.previewLink!=""){
						...
						edit.click(function(){
							$.colorbox({href:_settings.previewLink+'?'+tr.attr('previewLink'),iframe:true, innerWidth: '95%', innerHeight: '95%', scrolling: !isnicescroll,transition:'none',initialWidth:'95%',initialHeight:'95%',speed:200,fixed:true,onClosed:function(){parent.find('#refreshBtn').click()}});
						});
						td.append(edit);
					}
					if(_settings.delsrc!=""){
