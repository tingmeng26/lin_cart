...
$obj[]=array('type'=>'keyword','name'=>coderLang::t('filter3',1),'sql'=>true,
	'ary'=>array(
        ...
        array('column'=>'ps_name_en,ps_name_tw,ps_name_jp','name'=>coderLang::t("coderadmin3_class2",1)),
...
$obj[]=array('type'=>'select','name'=>coderLang::t("type", 1),'column'=>$colname['tid'],'sql'=>true,'ary'=>$typeList,'table'=>$type,'default' => $typeDefault);
