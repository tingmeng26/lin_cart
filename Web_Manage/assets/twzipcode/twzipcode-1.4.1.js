    ...
    var methods = {
        ...
        init: function (options) {
            ...
            return this.each(function () {
                ...
                $('<input/>').attr({ 'type': 'text', 'name': opts.zipcodeName, 'id': opts.zipcodeName, 'readonly': opts.readonly, 'size': '2' }).appendTo(this);
                $('<span class="lightblue"></span>').appendTo(this);
                //DOM collections
                wrap.selector = {
                ...
                */
                ...
                self.delegate(wrap.selector.district, 'change', function () {
                    var val = $(this).val();
					var v=$('#'+opts.countyName).val();
                    wrap.zipcode.val(data[v][val]);
                }
                );
