    ...
    <div class="container">
      <div class="row navbar-top">
        ...
        <div class="navbar-right">
          ...
          ｜
          <a onclick="changeLanguage('jp')"><?php coderLang::t('menu_lang_jp') ?></a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="navlist row">
      ...
      <div class="collapse navbar-collapse col-lg-7 col-md-9 col-sm-12 mr-auto" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav drop-down-menu">
          ...
          <li><a href="" class="dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <p><?php coderLang::t('menu_ec') ?></p>
            </a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item" href="https://www.rakuten.ne.jp/gold/pg-gloria/" target="_blank"><?php coderLang::t('menu_ec_jp') ?></a>
      ...
      <div class="nav-side col-lg-3 mr-auto navbar-right">
        <div class="box">
          <div class="search-container">
            ...
            <input type="search" id="search" placeholder="<?php coderLang::t('menu_txt_search') ?>" class="search">
          </div>
        </div>
        <div class="phone">
          <div class="phone-left"><i class="fas fa-phone"></i></div>
          <div class="phone-right">
            <h3 class="tel">+81-72-960-0500</h3>
            <div class="phone-bottom">
              <h7>(台北分店：02-2585-1552)</h7>
            </div>
          </div>
        </div>
      </div>
